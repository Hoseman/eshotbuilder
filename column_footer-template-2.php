              ...
              <tr> 
                ...
                <!-- offer button --> 
								...
								?>
                                        ...
                                        <span class="button-edit"><a style="font-size:15px; font-weight:bold;" href="column-edit.php?content_type=custom_footer_2_left&content_id=<?php echo $row['id'] ?>&content_position=left&eshot_id=<?php echo $row['eshot_id']; ?>&eshot_name=<?php echo $row['eshot_name']; ?>"><i class="fa fa-fw">&#xf040</i> Edit</a></span>
                ...
                <th width="300" valign="top" class="col-2-promos" style="<?php if(!empty($text_align_col_right)){ echo "text-align:".$text_align_col_right.";";  } ?>">
                 <!-- offer button --> 
                    ...
                    <span class="button-edit">
                        <a href="column-edit.php?content_type=custom_footer_2_right&content_id=<?php echo $row['id']; ?>&content_position=right&eshot_id=<?php echo $row['eshot_id']; ?>&eshot_name=<?php echo $row['eshot_name']; ?>"><i class="fa fa-fw">&#xf040</i> Edit</a>
                    </span>
