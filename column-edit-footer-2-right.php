...
try {
    ...
    $sql = "UPDATE $tbl_name SET padding_1=?, padding_2=?, padding_3=?, padding_4=?, col_bg_colour=?, text_align_col_right=?, social_icon_1=?, social_icon_2=?, social_icon_3=?, social_icon_4=?, social_icon_5=?, si_margin_top=?, si_padding=?, si_width=?, si_url_1=?, si_url_2=?, si_url_3=?, si_url_4=?, si_url_5=?, si_link_1=?, si_link_2=?, si_link_3=?, si_link_4=?, si_link_5=? WHERE id=?";
    $q = $conn->prepare($sql);
    $q->execute(array($padding_1,$padding_2,$padding_3,$padding_4,$col_bg_colour,$text_align_col_right,$social_icon_1,$social_icon_2,$social_icon_3,$social_icon_4,$social_icon_5,$si_margin_top,$si_padding,$si_width,$si_url_1,$si_url_2,$si_url_3,$si_url_4,$si_url_5,$si_link_1,$si_link_2,$si_link_3,$si_link_4,$si_link_5,$column_edit_id));
}
