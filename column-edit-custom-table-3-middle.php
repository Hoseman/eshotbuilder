...
$sql = "UPDATE $tbl_name SET padding_1=?, padding_2=?, padding_3=?, padding_4=?, col_bg_colour=?, text_align=?, ct_img_file_name_1=?, ct_img_url_1=?, ct_img_file_name_2=?, ct_img_url_2=?, ct_img_file_name_3=?, ct_img_url_3=? WHERE id=?";
$q = $conn->prepare($sql);
$q->execute(array($padding_1,$padding_2,$padding_3,$padding_4,$col_bg_colour,$text_align,$ct_img_file_name_1,$ct_img_url_1,$ct_img_file_name_2,$ct_img_url_2,$ct_img_file_name_3,$ct_img_url_3,$column_edit_id));	
}
