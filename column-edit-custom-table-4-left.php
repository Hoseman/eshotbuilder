...
$ct_img_file_name_left_4 = $_POST['ct_img_file_name_left_4'];
...
$ct_img_url_left_4 = $_POST['ct_img_url_left_4'];
...
$ct_img_alt_left_4 = $_POST['ct_img_alt_left_4'];
...
/*	
$sql = "UPDATE $tbl_name SET padding_1=?, padding_2=?, padding_3=?, padding_4=?, col_bg_colour=?, text_align_col_left=?, text_align_col_right=?, ct_img_file_name_left_1=?, ct_img_file_name_left_2=?, ct_img_file_name_left_3=?, ct_img_file_name_left_4=? WHERE id=?";
$q = $conn->prepare($sql);
$q->execute(array($padding_1,$padding_2,$padding_3,$padding_4,$col_bg_colour,$text_align_col_left,$text_align_col_right,$ct_img_file_name_left_1,$ct_img_file_name_left_2,$ct_img_file_name_left_3,$ct_img_file_name_left_4,$column_edit_id));	
}
...
$sql = "UPDATE $tbl_name SET padding_1=?, padding_2=?, padding_3=?, padding_4=?, col_bg_colour=?, text_align_col_left=?, text_align_col_left=?, ct_img_file_name_left_1=?, ct_img_alt_left_1=?, ct_img_url_left_1=?, ct_img_file_name_left_2=?, ct_img_alt_left_2=?, ct_img_url_left_2=?, ct_img_file_name_left_3=?, ct_img_alt_left_3=?, ct_img_url_left_3=?, ct_img_file_name_left_4=?, ct_img_alt_left_4=?, ct_img_url_left_4=? WHERE id=?";
$q = $conn->prepare($sql);
