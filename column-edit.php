...
<?php
	...
	elseif($content_type == "centered_image"){
?>
		<form action="column-edit-centered-image.php" method="post">	
<?php			
	}	
...
elseif($eshot_column == "9") {
    echo "<h2>Column Centered Image - #" . $id . "</h2>";
}
else {
...
<?php
if($content_type == "image" || $content_type == "centered_image"){
?>
<div class="column-edit-section">	
...
<?php
    if($content_type == "centered_image"){
?>
    <div class="column-edit-section">
        <label>Image Width:</label>
        <span><input type="text" class="input-4" name="column_centered_image_width" value="<?php if(!empty($column_centered_image_width)){ echo $column_centered_image_width; } else { echo "260"; } ?>"></span>
...
if($content_type == "centered_image"){
    ...
    <div class="column-edit-section">
        ...
        <select name="image_responsive">
            <option value="no" <?php if($image_responsive == "no"){ echo "selected"; } ?>>No</option>
            <option value="yes" <?php if($image_responsive == "yes"){ echo "selected"; } ?>>Yes</option>
        </select>
...
<select name="font_family">
    ...
    <option value="Georgia,serif" <?php if($font_family == "Georgia, serif"){ echo "selected"; } ?>>Georgia</option>
    <option value="'Roboto Slab', Georgia, serif" <?php if($font_family == "'Roboto Slab', Georgia, serif"){ echo "selected"; } ?>>Roboto Slab</option>
</select>
