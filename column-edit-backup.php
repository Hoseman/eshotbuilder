...
?>		
	<form action="column-edit-image.php" method="post">	
<?php	
	}
...
<?php
if($content_type == "text" || $content_type == "link" || $content_type == "custom_footer_1_left"){
...
<?php	
	...
	//if(count($records) != 0) {
		...
		//foreach ($records as $row) {
?>		<!--	
		<label for="font-<?php //echo $row['id']; ?>">

		<input type="radio" value="<?php //echo $row['colour']; ?>" name="font_colour" id="font-<?php //echo $row['id']; ?>" <?php //if($font_colour == $row['colour']){ echo 'checked="checked"'; } ?>>
		<span class="font-<?php //echo $row['id']; ?>-button"><?php //echo $row['colour_name']; ?></span>	
		</label>-->
